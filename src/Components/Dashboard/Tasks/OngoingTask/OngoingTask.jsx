...
const OngoingTask = ({ filteredData }) => {
  

  const onGoingTask = filteredData.filter(item => item.taskStatus === "onGoing");
  console.log('filterData onTasks', filteredData)
    ...
    <div className="min-h-screen p-4 lg:p-6">
      ...
      >
        <div className="bg-white shadow-md rounded-lg">
          <Table
            dataSource={Array.isArray(onGoingTask) ? onGoingTask : []}
            columns={columns}
