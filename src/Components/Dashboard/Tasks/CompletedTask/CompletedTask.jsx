...
const CompletedTask = ({ filteredData }) => {
  const navigate = useNavigate();
  const completeTask = filteredData.filter(item => item.taskStatus === "completed");
    ...
    <div className="min-h-screen p-4 lg:p-6">
      ...
      >
        <div className="bg-white shadow-md rounded-lg">
          <Table
            dataSource={Array.isArray(completeTask) ? completeTask : []}
            columns={columns}
